package com.mycompany.tictactoe.core;

import java.io.IOException;

import com.mycompany.tictactoe.Constants;
import com.mycompany.tictactoe.score.FileScoreManager;
import com.mycompany.tictactoe.score.ScoreManager;
import com.mycompany.tictactoe.ui.UI;
...
public class Game {
    ...
    private Player createPlayer(int index) {
        ...
        UI.printText("O jogador '" + name + "' vai usar o symbolo '" + symbol + "'");
